`google_search.py`: script for calling search API for passage retrieval. Warning: not extensively tested. only extract snippets instead of the all text from the webpage (sufficient for QA tasks).
